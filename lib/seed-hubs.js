// Content hubs — one per concern (15 total across 3 verticals).
// Source FR/EN ci-dessous ; la couche arabe vit dans lib/content-ar.js et est
// injectée à l'export par mergeAr() (rien n'est dupliqué ici).
import { HUBS_AR } from './content-ar.js'
import { mergeAr } from './merge-ar.js'

const SEED_HUBS_SOURCE = [
  // ================= SKINCARE =================
  {
...
export const SEED_HUBS = mergeAr(SEED_HUBS_SOURCE, HUBS_AR)
