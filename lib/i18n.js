...
// ---------------------------------------------------------------------------
export const AR = {
  // ---- Communauté : avis, Q&R, forum, modération ----
  'Avis des clients': 'آراء العملاء',
  'Écrire un avis': 'اكتب رأيًا',
  'Basé sur': 'استنادًا إلى',
  'avis': 'تقييم',
  'Vérifiés par Dermalyze': 'موثّقة من Dermalyze',
  'Aucun avis pour le moment. Soyez le premier à donner votre avis !': 'لا توجد آراء بعد. كن أول من يشارك رأيه!',
  'Merci ! Votre avis sera publié après validation par notre équipe.': 'شكرًا! سيُنشر رأيك بعد مراجعته من فريقنا.',
  'Votre note': 'تقييمك',
  'Email (optionnel, non publié)': 'البريد الإلكتروني (اختياري، لا يُنشر)',
  'Titre (optionnel)': 'عنوان (اختياري)',
  'Partagez votre expérience avec ce produit…': 'شارك تجربتك مع هذا المنتج…',
  'Publier mon avis': 'انشر رأيي',
  'Annuler': 'إلغاء',
  'Trier par': 'ترتيب حسب',
  'Plus récents': 'الأحدث',
  'Plus utiles': 'الأكثر فائدة',
  'Mieux notés': 'الأعلى تقييمًا',
  'Achat vérifié': 'شراء موثّق',
  'Utile': 'مفيد',
  'Choisissez une note.': 'اختر تقييمًا.',
  'Indiquez votre nom.': 'أدخل اسمك.',
  'Votre avis est trop court.': 'رأيك قصير جدًا.',
  'Une erreur est survenue.': 'حدث خطأ.',
  'Équipe Dermalyze': 'فريق Dermalyze',
  'Questions & réponses': 'أسئلة وأجوبة',
  'Poser une question': 'اطرح سؤالاً',
  'Merci ! Votre question sera publiée après validation.': 'شكرًا! سيُنشر سؤالك بعد المراجعة.',
  'Posez votre question sur ce produit…': 'اطرح سؤالك حول هذا المنتج…',
  'Envoyer': 'إرسال',
  'Aucune question pour le moment. Posez la première !': 'لا توجد أسئلة بعد. اطرح أول سؤال!',
  'Merci ! Votre réponse sera publiée après validation.': 'شكرًا! سيُنشر ردّك بعد المراجعة.',
  'Répondre': 'ردّ',
  'Votre réponse…': 'ردّك…',
  'Forum communautaire': 'منتدى المجتمع',
  'Posez vos questions, partagez vos routines et échangez avec la communauté Dermalyze. Chaque message est validé par notre équipe.': 'اطرح أسئلتك، شارك روتينك وتبادل الأفكار مع مجتمع Dermalyze. تتم مراجعة كل رسالة من قبل فريقنا.',
  'Toutes': 'الكل',
  'Nouvelle discussion': 'نقاش جديد',
  'Merci ! Votre discussion sera publiée après validation.': 'شكرًا! سيُنشر نقاشك بعد المراجعة.',
  'Titre de la discussion': 'عنوان النقاش',
  'Votre message…': 'رسالتك…',
  'Créer la discussion': 'إنشاء النقاش',
  'Aucune discussion pour le moment.': 'لا توجد نقاشات بعد.',
  'par': 'بواسطة',
  'réponses': 'ردود',
  'Retour au forum': 'العودة إلى المنتدى',
  'Discussion introuvable.': 'النقاش غير موجود.',
  'Répondre à la discussion': 'الرد على النقاش',
  'Publier': 'نشر',
  ...
  'Rejeter': 'رفض',
  'Supprimer': 'حذف',
  'Aucun élément.': 'لا عناصر.',
  'Vérifié': 'موثّق',
  'Marquer vérifié': 'تعليم كموثّق',
  'Retirer vérifié': 'إزالة التوثيق',
  'Épingler': 'تثبيت',
  'Désépingler': 'إلغاء التثبيت',
  'Réponses du forum': 'ردود المنتدى',
